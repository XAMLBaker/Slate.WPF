...
namespace Slate.Avalonia
{
    public interface ILayoutNavigator
    {
        ...
        Control CreateLayout(string url, object argu = null);
    }
    ...
    public class LayoutNavigator : ILayoutNavigator
    {
        ...
        public void SetRootLayout()
        {
            ...
            var layOutObject = (Control)this._container.Resolve (rootLayoutType);
        ...
        public Control CreateLayout(string url, object argu)
        {
            try
            {
                ...
                Control element = GetTopLayout (moduleName);
                if (element == null)
                {
                    return rootLayout;
                }
        ...
        private Control GetTopLayout(string moduleName)
        {
            ...
            return (Control)this._container.Resolve (contentType);
        }

        private Control GetLayout(string url, object argu = null)
        {
            ...
            if (_isGroupedWithLayout)
            {
                ...
                var layoutFrameworkElement = (Control)this._container.Resolve (layoutType);
            ...
            var contentFrameworkElement = (Control)this._container.Resolve (contentType);
