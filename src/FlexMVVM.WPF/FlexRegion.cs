    ...
    public class FlexRegion : ContentControl
    {
       ...
       DependencyProperty.Register (nameof (Transition), typeof (TransitionType), typeof (FlexRegion),
        ...
        public static readonly DependencyProperty TransitionDurationProperty =
            DependencyProperty.Register (nameof (TransitionDuration), typeof (Duration), typeof (FlexRegion),
        ...
        public static readonly DependencyProperty IsReverseProperty =
            DependencyProperty.Register (nameof (IsReverse), typeof (bool), typeof (FlexRegion),
     ...
     DependencyProperty.Register (nameof (RegionName), typeof (string), typeof (FlexRegion),
        ...
        static FlexRegion()
        {
            DefaultStyleKeyProperty.OverrideMetadata (typeof (FlexRegion), new FrameworkPropertyMetadata (typeof (FlexRegion)));
        }
