     ...
     DependencyProperty.Register (nameof (RegionName), typeof (string), typeof (SlateRegionControl),
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (_oldPresenter != null)
            {
                ...
                _oldPresenter.RenderTransform = new TranslateTransform ()
                {
                    X = 0,
                    Y = 0
                };
            ...
            if (_newPresenter != null)
            {
                ...
                _newPresenter.RenderTransform = new TranslateTransform ()
                {
                    X = 0,
                    Y = 0
                };
        ...
        {
            _rootGrid.Children.Remove (element);
            _rootGrid.Children.Insert (0, element);
        }
